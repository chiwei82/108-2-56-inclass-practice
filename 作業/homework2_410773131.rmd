...
Gamemaster[[1]][[731]] = Gamemaster[[1]][[1]] #複製格式

Gamemaster[[1]][[731]] = Gamemaster[[1]][[731]][-c(6,7,8,9,10,11)] #刪除不必要的部分

Gamemaster[[1]][[731]][c("dex","speciesName","speciesId","types")] =
  list(778,"Mimikyu","mimikyu",c("ghost","fairy"))#利用名字,按順序替換

Gamemaster[[1]][[731]][c("baseStats","fastMoves","chargedMoves","legacyMoves","defaultIVs")] = list(Gamemaster[[1]][[27]][[4]],Jigglypuff$fastMoves,Jigglypuff$chargedMoves,Jigglypuff$legacyMoves,Jigglypuff$defaultIVs) #利用名字,按順序替換
