...
data = semiGodsSemiDevils["data"][[1]]
section = data[[1]][[1]]
context_picked = data[[1]][[2]][section == "P2"]
...
context_picked_split = str_split(context_picked, pattern_1)
...
pattern_2 = "(段(譽|兄|兄弟|大哥|相公|君)(?!弟)|姓段的小子)"

mention_duan = str_extract_all(context_picked_split[[1]], pattern_2 )
