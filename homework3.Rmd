...
violatedArticles = levels(factor(badEmployers[[4]]))
...
pick_max = table_countsByArticle[ (table_countsByArticle == max(table_countsByArticle))==T ]
pick_max

mostViolatedArticle = pick_max
