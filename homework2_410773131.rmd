...
Gamemaster[[1]][[731]][c("dex","speciesName","speciesId","types")] =
  list(778,"Mimikyu","mimikyu",list("ghost","fairy"))#利用名字,按順序替換

Gamemaster[[1]][[731]][c("baseStats","fastMoves","chargedMoves","legacyMoves","defaultIVs")] = list(Pikachu_stats,Jigglypuff$fastMoves,Jigglypuff$chargedMoves,Jigglypuff$legacyMoves,Jigglypuff$defaultIVs) #利用名字,按順序替換
